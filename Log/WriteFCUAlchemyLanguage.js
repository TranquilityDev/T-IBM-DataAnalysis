...
lupus(0, 2, function(i) {

		alchemy_language.entities(parameters[i], function (err, response) {
			if (err)
				console.log('error:', err);
			else
				console.log(JSON.stringify(response, null, 20));
					fs.writeFile('/home/user/Tranquility/Temp-Data/'+AllTeachersNameList[i]+'entities.json',JSON.stringify(response, null, 20),  function(err) {
					if (err) {
	...
	alchemy_language.keywords(AllTeachersList[i], function (err, response) {
		if (err)
			console.log('error:', err);
				...
				fs.writeFile('/home/user/Tranquility/Temp-Data/'+AllTeachersNameList[i]+'.json',JSON.stringify(response, null, 2,callback));
